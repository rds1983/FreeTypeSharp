// Generated by Sichem at 2/24/2021 6:44:54 AM
...
namespace FreeTypeSharp
{
	unsafe partial class FreeType
	{
		...
		{
			public void* user;
			public delegate void* alloc_func(FT_MemoryRec_ a, int b); public alloc_func alloc;
			public delegate void free_func(FT_MemoryRec_ a, void* b); public free_func free;
			public delegate void* realloc_func(FT_MemoryRec_ a, int b, int c, void* d); public realloc_func realloc;
		}
		...
		public class FT_Raster_Params_
		{
			...
			public void* user;
			public FT_BBox_ clip_box = new FT_BBox_();
		}
		public class FT_Raster_Funcs_
		{
			...
			public delegate void raster_reset_func(void* a, byte* b, uint c); public raster_reset_func raster_reset;
			public delegate int raster_set_mode_func(void* a, uint b, void* c); public raster_set_mode_func raster_set_mode;
		...
		public class FT_FaceRec_
		{
			...
			public FT_Face_InternalRec_ _internal_;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class FT_SizeRec_
		{
			public FT_FaceRec_ face;
			public FT_Generic_ generic = new FT_Generic_();
			public FT_Size_Metrics_ metrics = new FT_Size_Metrics_();
			public FT_Size_InternalRec_* _internal_;
		}
		public class FT_GlyphSlotRec_
		{
			...
			public uint glyph_index = 0;
			public FT_Generic_ generic = new FT_Generic_();
			public FT_Glyph_Metrics_ metrics = new FT_Glyph_Metrics_();
			public int linearHoriAdvance = 0;
			public int linearVertAdvance = 0;
			public FT_Vector_ advance = new FT_Vector_();
			public int format = 0;
			public FT_Bitmap_ bitmap = new FT_Bitmap_();
			public int bitmap_left = 0;
			public int bitmap_top = 0;
			public FT_Outline_ outline = new FT_Outline_();
			public uint num_subglyphs = 0;
			public FT_SubGlyphRec_* subglyphs;
			public void* control_data;
			public int control_len = 0;
			public int lsb_delta = 0;
			public int rsb_delta = 0;
			public void* other;
			public FT_Slot_InternalRec_ _internal_;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class FT_Module_Class_
		{
			...
			public delegate void* get_interface_func(FT_ModuleRec_ a, sbyte* b); public get_interface_func get_interface;
		}
		public class FT_GlyphRec_
		{
			public FT_LibraryRec_ library;
		...
		public class FT_Renderer_Class_
		{
			...
			public int glyph_format = 0;
			public delegate int render_glyph_func(FT_RendererRec_ a, FT_GlyphSlotRec_ b, int c, FT_Vector_* d); public render_glyph_func render_glyph;
			...
			public delegate int set_mode_func(FT_RendererRec_ a, uint b, void* c); public set_mode_func set_mode;
		...
		public class FT_GlyphLoaderRec_
		{
			public FT_MemoryRec_ memory;
			public uint max_points = 0;
			public uint max_contours = 0;
			public uint max_subglyphs = 0;
			public byte use_extra = 0;
			public FT_GlyphLoadRec_ _base_ = new FT_GlyphLoadRec_();
			public FT_GlyphLoadRec_ current = new FT_GlyphLoadRec_();
			public void* other;
		}
		public class FT_Driver_ClassRec_
		{
			public FT_Module_Class_ root = new FT_Module_Class_();
			public int face_object_size = 0;
			public int size_object_size = 0;
			public int slot_object_size = 0;
			...
			public delegate int load_glyph_func(FT_GlyphSlotRec_ a, FT_SizeRec_ b, uint c, int d); public load_glyph_func load_glyph;
			public delegate int get_kerning_func(FT_FaceRec_ a, uint b, uint c, FT_Vector_* d); public get_kerning_func get_kerning;
			public delegate int attach_file_func(FT_FaceRec_ a, FT_StreamRec_ b); public attach_file_func attach_file;
			public delegate int get_advances_func(FT_FaceRec_ a, uint b, uint c, int d, int* e); public get_advances_func get_advances;
			public delegate int request_size_func(FT_SizeRec_ a, FT_Size_RequestRec_* b); public request_size_func request_size;
			public delegate int select_size_func(FT_SizeRec_ a, uint b); public select_size_func select_size;
		}
		[StructLayout(LayoutKind.Sequential)]
		public struct FT_AutoHinter_InterfaceRec_
		{
			public delegate void reset_face_func(void* a, FT_FaceRec_ b); public reset_face_func reset_face;
			public delegate void get_global_hints_func(void* a, FT_FaceRec_ b, void** c, int* d); public get_global_hints_func get_global_hints;
			public delegate void done_global_hints_func(void* a, void* b); public done_global_hints_func done_global_hints;
			public delegate int load_glyph_func(void* a, FT_GlyphSlotRec_ b, FT_SizeRec_ c, uint d, int e); public load_glyph_func load_glyph;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class FT_Incremental_FuncsRec_
		{
			public delegate int get_glyph_data_func(void* a, uint b, FT_Data_* c); public get_glyph_data_func get_glyph_data;
			public delegate void free_glyph_data_func(void* a, FT_Data_* b); public free_glyph_data_func free_glyph_data;
			public delegate int get_glyph_metrics_func(void* a, uint b, byte c, FT_Incremental_MetricsRec_* d); public get_glyph_metrics_func get_glyph_metrics;
		}
		public class FT_Incremental_InterfaceRec_
		{
			public FT_Incremental_FuncsRec_ funcs;
			public void* _object_;
		}
		public class FT_CMapRec_
		{
			public FT_CharMapRec_ charmap = new FT_CharMapRec_();
			public FT_CMap_ClassRec_ clazz;
		}
		public class FT_CMap_ClassRec_
		{
			public uint size = 0;
			...
			public delegate uint char_index_func(FT_CMapRec_ a, uint b); public char_index_func char_index;
			public delegate uint char_next_func(FT_CMapRec_ a, uint* b); public char_next_func char_next;
			public delegate uint char_var_index_func(FT_CMapRec_ a, FT_CMapRec_ b, uint c, uint d); public char_var_index_func char_var_index;
			public delegate int char_var_default_func(FT_CMapRec_ a, uint b, uint c); public char_var_default_func char_var_default;
			public delegate uint* variant_list_func(FT_CMapRec_ a, FT_MemoryRec_ b); public variant_list_func variant_list;
			public delegate uint* charvariant_list_func(FT_CMapRec_ a, FT_MemoryRec_ b, uint c); public charvariant_list_func charvariant_list;
			public delegate uint* variantchar_list_func(FT_CMapRec_ a, FT_MemoryRec_ b, uint c); public variantchar_list_func variantchar_list;
		}
		public class FT_Face_InternalRec_
		{
			public FT_Matrix_ transform_matrix = new FT_Matrix_();
			public FT_Vector_ transform_delta = new FT_Vector_();
			public int transform_flags = 0;
			public FT_ServiceCacheRec_ services = new FT_ServiceCacheRec_();
			public FT_Incremental_InterfaceRec_ incremental_interface;
			public sbyte no_stem_darkening = 0;
			public int random_seed = 0;
			public int refcount = 0;
		}
		public class FT_Slot_InternalRec_
		{
			public FT_GlyphLoaderRec_ loader;
			public uint flags = 0;
			public byte glyph_transformed = 0;
			public FT_Matrix_ glyph_matrix = new FT_Matrix_();
			public FT_Vector_ glyph_delta = new FT_Vector_();
		...
		public class FT_RendererRec_
		{
			...
			public void* raster;
			public delegate int raster_render_func(void* a, FT_Raster_Params_ b); public raster_render_func raster_render;
			public delegate int render_func(FT_RendererRec_ a, FT_GlyphSlotRec_ b, int c, FT_Vector_* d); public render_func render;
		}
		public class FT_DriverRec_
		{
			public FT_ModuleRec_ root = new FT_ModuleRec_();
			public FT_Driver_ClassRec_ clazz;
			public FT_ListRec_ faces_list = new FT_ListRec_();
		...
		public struct TT_SBit_RangeRec_
		{
			...
			public uint* glyph_offsets;
			public ushort* glyph_codes;
			public uint table_offset;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public struct TT_BDFRec_
		{
			...
			public byte* strings;
			public uint strings_size;
			public uint num_strikes;
			public byte loaded;
		}
		public class TT_FaceRec_
		{
			public FT_FaceRec_ root = new FT_FaceRec_();
			public TTC_HeaderRec_ ttc_header = new TTC_HeaderRec_();
			public uint format_tag = 0;
			public ushort num_tables = 0;
			public TT_TableRec_* dir_tables;
			public TT_Header_ header = new TT_Header_();
			public TT_HoriHeader_ horizontal = new TT_HoriHeader_();
			public TT_MaxProfile_ max_profile = new TT_MaxProfile_();
			public byte vertical_info = 0;
			public TT_VertHeader_ vertical = new TT_VertHeader_();
			public ushort num_names = 0;
			public TT_NameTableRec_ name_table = new TT_NameTableRec_();
			public TT_OS2_ os2 = new TT_OS2_();
			public TT_Postscript_ postscript = new TT_Postscript_();
			public byte* cmap_table;
			public uint cmap_size = 0;
			public delegate int goto_table_func(TT_FaceRec_ a, uint b, FT_StreamRec_ c, uint* d); public goto_table_func goto_table;
			public delegate int access_glyph_frame_func(TT_LoaderRec_ a, uint b, uint c, uint d); public access_glyph_frame_func access_glyph_frame;
			...
			public void* var;
			public void* psaux;
			public TT_Gasp_ gasp = new TT_Gasp_();
			public TT_PCLT_ pclt = new TT_PCLT_();
			public uint num_sbit_scales = 0;
			public TT_SBit_ScaleRec_* sbit_scales;
			public TT_Post_NamesRec_ postscript_names = new TT_Post_NamesRec_();
			public FT_Palette_Data_ palette_data = new FT_Palette_Data_();
			public ushort palette_index = 0;
			public FT_Color_* palette;
			public byte have_foreground_color = 0;
			public FT_Color_ foreground_color = new FT_Color_();
			public uint font_program_size = 0;
			public byte* font_program;
			public uint cvt_program_size = 0;
			public byte* cvt_program;
			public uint cvt_size = 0;
			public int* cvt;
			public delegate int interpreter_func(void* a); public interpreter_func interpreter;
			public FT_Generic_ extra = new FT_Generic_();
			public sbyte* postscript_name;
			public uint glyf_len = 0;
			public uint glyf_offset = 0;
			public byte is_cff2 = 0;
			public byte doblend = 0;
			public void* blend;
			public uint variation_support = 0;
			public sbyte* var_postscript_prefix;
			public uint var_postscript_prefix_len = 0;
			public uint horz_metrics_size = 0;
			public uint vert_metrics_size = 0;
			public uint num_locations = 0;
			public byte* glyph_locations;
			public byte* hdmx_table;
			public uint hdmx_table_size = 0;
			public uint hdmx_record_count = 0;
			public uint hdmx_record_size = 0;
			public byte* hdmx_record_sizes;
			public byte* sbit_table;
			public uint sbit_table_size = 0;
			public int sbit_table_type = 0;
			public uint sbit_num_strikes = 0;
			public uint* sbit_strike_map;
			public byte* kern_table;
			public uint kern_table_size = 0;
			public uint num_kern_tables = 0;
			public uint kern_avail_bits = 0;
			public uint kern_order_bits = 0;
			public TT_BDFRec_ bdf = new TT_BDFRec_();
			public uint horz_metrics_offset = 0;
			public uint vert_metrics_offset = 0;
			public uint ebdt_start = 0;
			public uint ebdt_size = 0;
			public void* cpal;
			public void* colr;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class TT_LoaderRec_
		{
			...
			public int linear = 0;
			public byte linear_def = 0;
			public FT_Vector_ pp1 = new FT_Vector_();
			public FT_Vector_ pp2 = new FT_Vector_();
			public TT_GlyphZoneRec_ _base_ = new TT_GlyphZoneRec_();
			public TT_GlyphZoneRec_ zone = new TT_GlyphZoneRec_();
			public void* exec;
			public byte* instructions;
			public uint ins_pos = 0;
			public void* other;
			public int top_bearing = 0;
			public int vadvance = 0;
			public FT_Vector_ pp3 = new FT_Vector_();
			public FT_Vector_ pp4 = new FT_Vector_();
			public byte* cursor;
			public byte* limit;
			public FT_ListRec_ composites = new FT_ListRec_();
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public struct WOFF2_HeaderRec_
		{
			...
			public uint compressed_offset;
			public uint header_version;
			public ushort num_fonts;
			public uint actual_sfnt_size;
		...
		public class SFNT_Interface_
		{
			...
			public delegate void* get_interface_func(FT_ModuleRec_ a, sbyte* b); public get_interface_func get_interface;
			public delegate int load_any_func(TT_FaceRec_ a, uint b, int c, byte* d, uint* e); public load_any_func load_any;
			public delegate int load_head_func(TT_FaceRec_ a, FT_StreamRec_ b); public load_head_func load_head;
			public delegate int load_hhea_func(TT_FaceRec_ a, FT_StreamRec_ b, byte c); public load_hhea_func load_hhea;
			...
			public delegate int load_sbit_image_func(TT_FaceRec_ a, uint b, uint c, uint d, FT_StreamRec_ e, FT_Bitmap_* f, TT_SBit_MetricsRec_* g); public load_sbit_image_func load_sbit_image;
			public delegate int get_psname_func(TT_FaceRec_ a, uint b, sbyte** c); public get_psname_func get_psname;
			public delegate void free_psnames_func(TT_FaceRec_ a); public free_psnames_func free_psnames;
			public delegate int get_kerning_func(TT_FaceRec_ a, uint b, uint c); public get_kerning_func get_kerning;
			public delegate int load_font_dir_func(TT_FaceRec_ a, FT_StreamRec_ b); public load_font_dir_func load_font_dir;
			public delegate int load_hmtx_func(TT_FaceRec_ a, FT_StreamRec_ b, byte c); public load_hmtx_func load_hmtx;
			...
			public delegate int set_sbit_strike_func(TT_FaceRec_ a, FT_Size_RequestRec_* b, uint* c); public set_sbit_strike_func set_sbit_strike;
			public delegate int load_strike_metrics_func(TT_FaceRec_ a, uint b, FT_Size_Metrics_* c); public load_strike_metrics_func load_strike_metrics;
			...
			public delegate int set_palette_func(TT_FaceRec_ a, uint b); public set_palette_func set_palette;
			public delegate byte get_colr_layer_func(TT_FaceRec_ a, uint b, uint* c, uint* d, FT_LayerIterator_* e); public get_colr_layer_func get_colr_layer;
			public delegate int colr_blend_func(TT_FaceRec_ a, uint b, FT_GlyphSlotRec_ c, FT_GlyphSlotRec_ d); public colr_blend_func colr_blend;
			public delegate void get_metrics_func(TT_FaceRec_ a, byte b, uint c, short* d, ushort* e); public get_metrics_func get_metrics;
			public delegate int get_name_func(TT_FaceRec_ a, ushort b, sbyte** c); public get_name_func get_name;
			public delegate byte get_name_id_func(TT_FaceRec_ a, ushort b, int* c, int* d); public get_name_id_func get_name_id;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		{
			public delegate int func_func(FT_LibraryRec_ a, FT_StreamRec_ b, sbyte* c, sbyte** d, int* e); public func_func func;
			public int type = 0;
		}
		public class PSH_Globals_FuncsRec_
		{
			public delegate int create_func(FT_MemoryRec_ a, PS_PrivateRec_* b, void** c); public create_func create;
			public delegate void set_scale_func(void* a, int b, int c, int d, int e); public set_scale_func set_scale;
			public delegate void destroy_func(void* a); public destroy_func destroy;
		}
		public class T1_Hints_FuncsRec_
		{
			public void* hints;
			public delegate void open_func(void* a); public open_func open;
			public delegate int close_func(void* a, uint b); public close_func close;
			public delegate void stem_func(void* a, uint b, int* c); public stem_func stem;
			public delegate void stem3_func(void* a, uint b, int* c); public stem3_func stem3;
			public delegate void reset_func(void* a, uint b); public reset_func reset;
			public delegate int apply_func(void* a, FT_Outline_* b, void* c, int d); public apply_func apply;
		}
		public class T2_Hints_FuncsRec_
		{
			public void* hints;
			public delegate void open_func(void* a); public open_func open;
			public delegate int close_func(void* a, uint b); public close_func close;
			public delegate void stems_func(void* a, uint b, int c, int* d); public stems_func stems;
			public delegate void hintmask_func(void* a, uint b, uint c, byte* d); public hintmask_func hintmask;
			public delegate void counter_func(void* a, uint b, byte* c); public counter_func counter;
			public delegate int apply_func(void* a, FT_Outline_* b, void* c, int d); public apply_func apply;
		}
		public class PSHinter_Interface_
		{
			...
			public delegate T1_Hints_FuncsRec_ get_t1_funcs_func(FT_ModuleRec_ a); public get_t1_funcs_func get_t1_funcs;
			public delegate T2_Hints_FuncsRec_ get_t2_funcs_func(FT_ModuleRec_ a); public get_t2_funcs_func get_t2_funcs;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class PS_UnicodesRec_
		{
			public FT_CMapRec_ cmap = new FT_CMapRec_();
			public uint num_maps = 0;
		...
		public struct CFF_FontRecDictRec_
		{
			...
			public FT_BBox_ font_bbox;
			public int stroke_width;
			public uint charset_offset;
			public uint encoding_offset;
			public uint charstrings_offset;
			public uint private_offset;
			public uint private_size;
			...
			public int cid_font_type;
			public uint cid_count;
			public uint cid_uid_base;
			public uint cid_fd_array_offset;
			public uint cid_fd_select_offset;
			public uint cid_font_name;
			public ushort num_designs;
			public ushort num_axes;
			public uint vstore_offset;
		...
		public struct CFF_PrivateRec_
		{
			...
			public uint local_subrs_offset;
		...
		public class CFF_SubFontRec_
		{
			public CFF_FontRecDictRec_ font_dict = new CFF_FontRecDictRec_();
			public CFF_PrivateRec_ private_dict = new CFF_PrivateRec_();
			public CFF_BlendRec_ blend = new CFF_BlendRec_();
			public uint lenNDV = 0;
			public int* NDV;
			public byte* blend_stack;
			public byte* blend_top;
			public uint blend_used = 0;
			public uint blend_alloc = 0;
			public CFF_IndexRec_ local_subrs_index = new CFF_IndexRec_();
			public byte** local_subrs;
			public uint random = 0;
		}
		public class CFF_FontRec_
		{
			public FT_LibraryRec_ library;
			public FT_StreamRec_ stream;
			public FT_MemoryRec_ memory;
			public uint base_offset = 0;
			public uint num_faces = 0;
			public uint num_glyphs = 0;
			public byte version_major = 0;
			public byte version_minor = 0;
			public byte header_size = 0;
			public uint top_dict_length = 0;
			public byte cff2 = 0;
			public CFF_IndexRec_ name_index = new CFF_IndexRec_();
			public CFF_IndexRec_ top_dict_index = new CFF_IndexRec_();
			public CFF_IndexRec_ global_subrs_index = new CFF_IndexRec_();
			public CFF_EncodingRec_ encoding = new CFF_EncodingRec_();
			public CFF_CharsetRec_ charset = new CFF_CharsetRec_();
			public CFF_IndexRec_ charstrings_index = new CFF_IndexRec_();
			public CFF_IndexRec_ font_dict_index = new CFF_IndexRec_();
			public CFF_IndexRec_ private_index = new CFF_IndexRec_();
			public CFF_IndexRec_ local_subrs_index = new CFF_IndexRec_();
			public sbyte* font_name;
			public byte** global_subrs;
			public uint num_strings = 0;
			public byte** strings;
			public byte* string_pool;
			public uint string_pool_size = 0;
			public CFF_SubFontRec_ top_font = new CFF_SubFontRec_();
			public uint num_subfonts = 0;
			public CFF_SubFontRec_[] subfonts = new CFF_SubFontRec_[256];
			public CFF_FDSelectRec_ fd_select = new CFF_FDSelectRec_();
			...
			public sbyte* registry;
			public sbyte* ordering;
			public FT_Generic_ cf2_instance = new FT_Generic_();
			public CFF_VStoreRec_ vstore = new CFF_VStoreRec_();
			public PS_FontExtraRec_* font_extra;
		}
		public class CFF_SizeRec_
		{
			public FT_SizeRec_ root = new FT_SizeRec_();
			public uint strike_index = 0;
		}
		public class CFF_GlyphSlotRec_
		{
			public FT_GlyphSlotRec_ root = new FT_GlyphSlotRec_();
			public byte hint = 0;
			public byte scaled = 0;
		...
		public class PS_Table_FuncsRec_
		{
			...
			public delegate int add_func(PS_TableRec_ a, int b, void* c, uint d); public add_func add;
			public delegate void release_func(PS_TableRec_ a); public release_func release;
		}
		public class PS_TableRec_
		{
			public byte* block;
			public ulong cursor = 0;
			public ulong capacity = 0;
			public uint init = 0;
			public int max_elems = 0;
			public int num_elems = 0;
			public byte** elements;
			public uint* lengths;
			public FT_MemoryRec_ memory;
			public PS_Table_FuncsRec_ funcs = new PS_Table_FuncsRec_();
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class T1_FieldRec_
		{
			...
			public byte size = 0;
			public uint array_max = 0;
			public uint count_offset = 0;
			public uint dict = 0;
		}
		public class PS_Parser_FuncsRec_
		{
			public delegate void init_func(PS_ParserRec_ a, byte* b, byte* c, FT_MemoryRec_ d); public init_func init;
			...
			public delegate int to_int_func(PS_ParserRec_ a); public to_int_func to_int;
			public delegate int to_fixed_func(PS_ParserRec_ a, int b); public to_fixed_func to_fixed;
			public delegate int to_bytes_func(PS_ParserRec_ a, byte* b, ulong c, uint* d, byte e); public to_bytes_func to_bytes;
			public delegate int to_coord_array_func(PS_ParserRec_ a, int b, short* c); public to_coord_array_func to_coord_array;
			public delegate int to_fixed_array_func(PS_ParserRec_ a, int b, int* c, int d); public to_fixed_array_func to_fixed_array;
			public delegate void to_token_func(PS_ParserRec_ a, T1_TokenRec_* b); public to_token_func to_token;
			public delegate void to_token_array_func(PS_ParserRec_ a, T1_TokenRec_* b, uint c, int* d); public to_token_array_func to_token_array;
			public delegate int load_field_func(PS_ParserRec_ a, T1_FieldRec_ b, void** c, uint d, uint* e); public load_field_func load_field;
			public delegate int load_field_table_func(PS_ParserRec_ a, T1_FieldRec_ b, void** c, uint d, uint* e); public load_field_table_func load_field_table;
		}
		public class PS_ParserRec_
		{
			public byte* cursor;
			public byte* _base_;
			public byte* limit;
			public int error = 0;
			public FT_MemoryRec_ memory;
			public PS_Parser_FuncsRec_ funcs = new PS_Parser_FuncsRec_();
		}
		[StructLayout(LayoutKind.Sequential)]
		public struct PS_Builder_FuncsRec_
		{
			public delegate void init_func(PS_Builder_ a, void* b, byte c); public init_func init;
			public delegate void done_func(PS_Builder_ a); public done_func done;
		}
		public class PS_Builder_
		{
			public FT_MemoryRec_ memory;
			public FT_FaceRec_ face;
			...
			public byte path_begun = 0;
			public byte load_points = 0;
			public byte no_recurse = 0;
			public byte metrics_only = 0;
			public byte is_t1 = 0;
			public PS_Builder_FuncsRec_ funcs = new PS_Builder_FuncsRec_();
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class PS_Decoder_
		{
			public PS_Builder_ builder = new PS_Builder_();
			public int[] stack = new int[48 + 1];
			public int* top;
			public PS_Decoder_Zone_[] zones = new PS_Decoder_Zone_[16 + 1];
			public PS_Decoder_Zone_* zone;
			public int flex_state = 0;
			public int num_flex_vectors = 0;
			public FT_Vector_[] flex_vectors = new FT_Vector_[7];
			public CFF_FontRec_ cff;
			public CFF_SubFontRec_ current_subfont;
			public FT_Generic_ cf2_instance;
			public int* glyph_width;
			public byte width_only = 0;
			public int num_hints = 0;
			public uint num_locals = 0;
			public uint num_globals = 0;
			public int locals_bias = 0;
			public int globals_bias = 0;
			public byte** locals;
			public byte** globals;
			public byte** glyph_names;
			public uint num_glyphs = 0;
			public int hint_mode = 0;
			public byte seac = 0;
			public delegate int get_glyph_callback_func(TT_FaceRec_ a, uint b, byte** c, uint* d); public get_glyph_callback_func get_glyph_callback;
			public delegate void free_glyph_callback_func(TT_FaceRec_ a, byte** b, uint c); public free_glyph_callback_func free_glyph_callback;
			public FT_Service_PsCMapsRec_ psnames;
			public int lenIV = 0;
			public uint* locals_len;
			public FT_HashRec_ locals_hash;
			public FT_Matrix_ font_matrix = new FT_Matrix_();
			public FT_Vector_ font_offset = new FT_Vector_();
			public PS_BlendRec_ blend;
			public int* buildchar;
			public uint len_buildchar = 0;
		}
		public class T1_Builder_FuncsRec_
		{
			public delegate void init_func(T1_BuilderRec_ a, FT_FaceRec_ b, FT_SizeRec_ c, FT_GlyphSlotRec_ d, byte e); public init_func init;
			...
			public delegate void add_point_func(T1_BuilderRec_ a, int b, int c, byte d); public add_point_func add_point;
			public delegate int add_point1_func(T1_BuilderRec_ a, int b, int c); public add_point1_func add_point1;
			public delegate int add_contour_func(T1_BuilderRec_ a); public add_contour_func add_contour;
			public delegate int start_point_func(T1_BuilderRec_ a, int b, int c); public start_point_func start_point;
			public delegate void close_contour_func(T1_BuilderRec_ a); public close_contour_func close_contour;
		}
		public class T1_BuilderRec_
		{
			public FT_MemoryRec_ memory;
			public FT_FaceRec_ face;
			public FT_GlyphSlotRec_ glyph;
			...
			public int pos_x = 0;
			public int pos_y = 0;
			public FT_Vector_ left_bearing = new FT_Vector_();
			public FT_Vector_ advance = new FT_Vector_();
			public FT_BBox_ bbox = new FT_BBox_();
			...
			public T1_Builder_FuncsRec_ funcs = new T1_Builder_FuncsRec_();
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class T1_DecoderRec_
		{
			public T1_BuilderRec_ builder = new T1_BuilderRec_();
			public int[] stack = new int[256];
			public int* top;
			public T1_Decoder_ZoneRec_[] zones = new T1_Decoder_ZoneRec_[16 + 1];
			public T1_Decoder_ZoneRec_* zone;
			public FT_Service_PsCMapsRec_ psnames;
			public uint num_glyphs = 0;
			public byte** glyph_names;
			public int lenIV = 0;
			public int num_subrs = 0;
			public byte** subrs;
			public uint* subrs_len;
			public FT_HashRec_ subrs_hash;
			public FT_Matrix_ font_matrix = new FT_Matrix_();
			...
			public PS_BlendRec_ blend;
			public int hint_mode = 0;
			public delegate int parse_callback_func(T1_DecoderRec_ a, uint b); public parse_callback_func parse_callback;
			public T1_Decoder_FuncsRec_ funcs = new T1_Decoder_FuncsRec_();
			public int* buildchar;
			public uint len_buildchar = 0;
			public byte seac = 0;
			public FT_Generic_ cf2_instance = new FT_Generic_();
		...
		{
			public delegate void init_func(CFF_Builder_ a, TT_FaceRec_ b, CFF_SizeRec_ c, CFF_GlyphSlotRec_ d, byte e); public init_func init;
			...
			public delegate void add_point_func(CFF_Builder_ a, int b, int c, byte d); public add_point_func add_point;
			public delegate int add_point1_func(CFF_Builder_ a, int b, int c); public add_point1_func add_point1;
			public delegate int add_contour_func(CFF_Builder_ a); public add_contour_func add_contour;
			public delegate int start_point_func(CFF_Builder_ a, int b, int c); public start_point_func start_point;
			public delegate void close_contour_func(CFF_Builder_ a); public close_contour_func close_contour;
		}
		public class CFF_Builder_
		{
			public FT_MemoryRec_ memory;
			public TT_FaceRec_ face;
			public CFF_GlyphSlotRec_ glyph;
			...
			public void* hints_funcs;
			public void* hints_globals;
			public CFF_Builder_FuncsRec_ funcs = new CFF_Builder_FuncsRec_();
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		public class CFF_Decoder_
		{
			public CFF_Builder_ builder = new CFF_Builder_();
			public CFF_FontRec_ cff;
			public int[] stack = new int[48 + 1];
			public int* top;
			public CFF_Decoder_Zone_[] zones = new CFF_Decoder_Zone_[16 + 1];
			public CFF_Decoder_Zone_* zone;
			public int flex_state = 0;
			public int num_flex_vectors = 0;
			public FT_Vector_[] flex_vectors = new FT_Vector_[7];
			public int glyph_width = 0;
			public int nominal_width = 0;
			public byte read_width = 0;
			public byte width_only = 0;
			public int num_hints = 0;
			public int[] buildchar = new int[32];
			public uint num_locals = 0;
			public uint num_globals = 0;
			public int locals_bias = 0;
			public int globals_bias = 0;
		...
		public class AFM_Parser_FuncsRec_
		{
			public delegate int init_func(AFM_ParserRec_ a, FT_MemoryRec_ b, byte* c, byte* d); public init_func init;
		...
		public class AFM_ParserRec_
		{
			public FT_MemoryRec_ memory;
			public void* stream;
			public AFM_FontInfoRec_* FontInfo;
			public delegate int get_index_func(sbyte* a, ulong b, void* c); public get_index_func get_index;
			public void* user_data;
		}
		public class T1_CMap_ClassesRec_
		{
		...
		public struct PSAux_ServiceRec_
		{
			...
			public delegate void t1_decrypt_func(byte* a, ulong b, ushort c); public t1_decrypt_func t1_decrypt;
			public delegate uint cff_random_func(uint a); public cff_random_func cff_random;
			public delegate void ps_decoder_init_func(PS_Decoder_ a, void* b, byte c); public ps_decoder_init_func ps_decoder_init;
		...
		public class FT_Service_PropertiesRec_
		{
			public delegate int set_property_func(FT_ModuleRec_ a, sbyte* b, void* c, byte d); public set_property_func set_property;
			public delegate int get_property_func(FT_ModuleRec_ a, sbyte* b, void* c); public get_property_func get_property;
		}
		public class FT_Service_SFNT_TableRec_
		{
			public delegate int load_table_func(FT_FaceRec_ a, uint b, int c, byte* d, uint* e); public load_table_func load_table;
			public delegate void* get_table_func(FT_FaceRec_ a, int b); public get_table_func get_table;
			public delegate int table_info_func(FT_FaceRec_ a, uint b, uint* c, uint* d, uint* e); public table_info_func table_info;
		}
		public class FT_Service_PsFontNameRec_
		{
			public delegate sbyte* get_ps_font_name_func(FT_FaceRec_ a); public get_ps_font_name_func get_ps_font_name;
		}
		public class FT_Service_GlyphDictRec_
		{
			public delegate int get_name_func(FT_FaceRec_ a, uint b, void* c, uint d); public get_name_func get_name;
			public delegate uint name_index_func(FT_FaceRec_ a, sbyte* b); public name_index_func name_index;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		{
			public delegate int get_track_func(FT_FaceRec_ a, int b, int c, int* d); public get_track_func get_track;
		}
		[StructLayout(LayoutKind.Sequential)]
		...
		{
			FT_Driver_ClassRec_.get_advances_func func;
			if (face == null)
		...
		{
			return (int)(((int)((uint)(a) + (uint)(0x8000 - ((a) < (0))))) & ~0xFFFF);
		}

		public static int FT_CeilFix(int a)
		{
			return (int)(((int)((uint)(a) + (uint)(0xFFFF))) & ~0xFFFF);
		}
		...
		public static int FT_MulDiv(int a_, int b_, int c_)
		{
			...
			d_ = ((int)(d));
			return (int)((s) < (0) ? (int)((uint)(0) - (uint)(d_)) : d_);
		}
		...
		public static int FT_DivFix(int a_, int b_)
		{
			...
			q_ = ((int)(q));
			return (int)((s) < (0) ? (int)((uint)(0) - (uint)(q_)) : q_);
		}
		...
		public static void FT_Matrix_Multiply(FT_Matrix_* a, FT_Matrix_* b)
		{
			...
			if ((a == null) || (b == null))
				return;
			xx = ((int)((uint)(FT_MulFix((int)(a->xx), (int)(b->xx))) + (uint)(FT_MulFix((int)(a->xy), (int)(b->yx)))));
			xy = ((int)((uint)(FT_MulFix((int)(a->xx), (int)(b->xy))) + (uint)(FT_MulFix((int)(a->xy), (int)(b->yy)))));
			yx = ((int)((uint)(FT_MulFix((int)(a->yx), (int)(b->xx))) + (uint)(FT_MulFix((int)(a->yy), (int)(b->yx)))));
			yy = ((int)((uint)(FT_MulFix((int)(a->yx), (int)(b->xy))) + (uint)(FT_MulFix((int)(a->yy), (int)(b->yy)))));
			b->xx = (int)(xx);
			b->xy = (int)(xy);
			b->yx = (int)(yx);
			b->yy = (int)(yy);
		...
		public static void FT_Matrix_Multiply_Scaled(FT_Matrix_* a, FT_Matrix_* b, int scaling)
		{
			...
			if ((a == null) || (b == null))
				return;
			xx = ((int)((uint)(FT_MulDiv((int)(a->xx), (int)(b->xx), (int)(val))) + (uint)(FT_MulDiv((int)(a->xy), (int)(b->yx), (int)(val)))));
			xy = ((int)((uint)(FT_MulDiv((int)(a->xx), (int)(b->xy), (int)(val))) + (uint)(FT_MulDiv((int)(a->xy), (int)(b->yy), (int)(val)))));
			yx = ((int)((uint)(FT_MulDiv((int)(a->yx), (int)(b->xx), (int)(val))) + (uint)(FT_MulDiv((int)(a->yy), (int)(b->yx), (int)(val)))));
			yy = ((int)((uint)(FT_MulDiv((int)(a->yx), (int)(b->xy), (int)(val))) + (uint)(FT_MulDiv((int)(a->yy), (int)(b->yy), (int)(val)))));
			b->xx = (int)(xx);
			b->xy = (int)(xy);
			b->yx = (int)(yx);
			b->yy = (int)(yy);
		...
		public static void FT_Vector_Transform_Scaled(FT_Vector_* vector, FT_Matrix_* matrix, int scaling)
		{
			...
			if ((vector == null) || (matrix == null))
				return;
			xz = ((int)((uint)(FT_MulDiv((int)(vector->x), (int)(matrix->xx), (int)(val))) + (uint)(FT_MulDiv((int)(vector->y), (int)(matrix->xy), (int)(val)))));
			yz = ((int)((uint)(FT_MulDiv((int)(vector->x), (int)(matrix->yx), (int)(val))) + (uint)(FT_MulDiv((int)(vector->y), (int)(matrix->yy), (int)(val)))));
			vector->x = (int)(xz);
			vector->y = (int)(yz);
		}
		...
		public static uint hash_str_lookup(FT_Hashkey_* key)
		{
			sbyte* kp = key->str;
			uint res = (uint)(0);
			while ((*kp) != 0)
			{ res = (uint)((res << 5) - res + (uint)(*kp++)); }
			return (uint)(res);
		}

		public static uint hash_num_lookup(FT_Hashkey_* key)
		{
			uint num = (uint)(key->num);
			uint res = 0;
			res = (uint)(num & 0xFF);
			res = (uint)((res << 5) - res + ((num >> 8) & 0xFF));
			res = (uint)((res << 5) - res + ((num >> 16) & 0xFF));
			res = (uint)((res << 5) - res + ((num >> 24) & 0xFF));
			return (uint)(res);
		}

		public static byte hash_str_compare(FT_Hashkey_* a, FT_Hashkey_* b)
		{
		...
		public static byte hash_num_compare(FT_Hashkey_* a, FT_Hashkey_* b)
		{
			if ((a->num) == (b->num))
				return (byte)(1);
			return (byte)(0);
		...
		public static FT_HashnodeRec_** hash_bucket(FT_Hashkey_ key, FT_HashRec_ hash)
		{
			uint res = (uint)(0);
			FT_HashnodeRec_** bp = hash.table;
			FT_HashnodeRec_** ndp;
			res = (uint)(hash.lookup(&key));
		...
		public static int hash_rehash(FT_HashRec_ hash, FT_MemoryRec_ memory)
		{
			...
			for (i = (uint)(0), bp = obp; (i) < (sz); i++, bp++)
			{
				if ((*bp) != null)
				{
					nbp = hash_bucket((FT_Hashkey_)((*bp)->key), hash);
					*nbp = *bp;
				}
			}
			do
			{
				(ft_mem_free(memory, (obp)));
				(obp) = null;
			}
			while ((0) != 0);
		Exit:
		...
		public static int hash_insert(FT_Hashkey_ key, ulong data, FT_HashRec_ hash, FT_MemoryRec_ memory)
		{
			FT_HashnodeRec_* nn;
			FT_HashnodeRec_** bp = hash_bucket((FT_Hashkey_)(key), hash);
			int error = (int)(FT_Err_Ok);
			nn = *bp;
			if (nn == null)
			{
		...
		{
			FT_Hashkey_ hk = new FT_Hashkey_();
			hk.str = key;
			return (int)(hash_insert((FT_Hashkey_)(hk), (ulong)(data), hash, memory));
		}
		...
		public static ulong* hash_lookup(FT_Hashkey_ key, FT_HashRec_ hash)
		{
			FT_HashnodeRec_** np = hash_bucket((FT_Hashkey_)(key), hash);
		...
		public static ulong* ft_hash_str_lookup(sbyte* key, FT_HashRec_ hash)
		{
			FT_Hashkey_ hk = new FT_Hashkey_();
			hk.str = key;
			return hash_lookup((FT_Hashkey_)(hk), hash);
		}
		...
		public static void ft_validator_init(FT_ValidatorRec_* valid, byte* _base_, byte* limit, int level)
		{
			valid->_base_ = _base_;
			valid->limit = limit;
		...
		public static int ft_validator_run(FT_ValidatorRec_* valid)
		{
			((valid) = (valid));
			return (int)(-1);
		}

		public static void ft_validator_error(FT_ValidatorRec_* valid, int error)
		{
			_SETJMP_FLOAT128[]*jump_buffer;
		...
		public static int FT_Stream_New(FT_LibraryRec_ library, FT_Open_Args_* args, FT_StreamRec_ astream)
		{
			...
			if ((args->flags & 1) != 0)
			{
				FT_Stream_OpenMemory(stream, args->memory_base, (uint)(args->memory_size));
			}
		...
		public static int ft_glyphslot_init(FT_GlyphSlotRec_ slot)
		{
			...
			int error = (int)(FT_Err_Ok);
			FT_Slot_InternalRec_ _internal_ = null;
			slot.library = driver.root.library;
			if ((((_internal_) = (ft_mem_alloc(memory, (int)(sizeof((_internal_))), &error))), error != 0))
				goto Exit;
			slot._internal_ = _internal_;
			if ((((FT_ModuleRec_)(driver)).clazz.module_flags & 512) == 0)
				error = (int)(FT_GlyphLoader_New(memory, _internal_.loader));
			if ((error == 0) && ((clazz.init_slot) != null))
				error = (int)(clazz.init_slot(slot));
			Exit:
			;
			return (int)(error);
		}
		...
		{
			if (((slot._internal_) != null) && ((slot._internal_.flags & 1) != 0))
			{
		...
		public static int ft_glyphslot_alloc_bitmap(FT_GlyphSlotRec_ slot, uint size)
		{
			FT_MemoryRec_ memory = (slot.face).memory;
			int error = 0;
			if ((slot._internal_.flags & 1) != 0)
				do
				{
					(ft_mem_free(memory, (slot.bitmap.buffer)));
					(slot.bitmap.buffer) = null;
		...
		public static void ft_glyphslot_done(FT_GlyphSlotRec_ slot)
		{
			...
			ft_glyphslot_free_bitmap(slot);
			if ((slot._internal_) != null)
			{
				if ((((FT_ModuleRec_)(driver)).clazz.module_flags & 512) == 0)
				{
					FT_GlyphLoader_Done(slot._internal_.loader);
					slot._internal_.loader = null;
				}
				do
				{
					(ft_mem_free(memory, (slot._internal_)));
					(slot._internal_) = null;
				}
				while ((0) != 0);
			}
		...
		{
			FT_Face_InternalRec_ _internal_;
			if (face == null)
				return;
			_internal_ = face._internal_;
			_internal_.transform_flags = (int)(0);
			if (matrix == null)
			{
				_internal_.transform_matrix.xx = (int)(0x10000);
				_internal_.transform_matrix.xy = (int)(0);
				_internal_.transform_matrix.yx = (int)(0);
				_internal_.transform_matrix.yy = (int)(0x10000);
				matrix = &_internal_.transform_matrix;
			}
			else
				_internal_.transform_matrix = (FT_Matrix_)(*matrix);
			if ((((matrix->xy | matrix->yx) != 0) || (matrix->xx != 0x10000)) || (matrix->yy != 0x10000))
				_internal_.transform_flags |= (int)(1);
			if (delta == null)
			{
				_internal_.transform_delta.x = (int)(0);
				_internal_.transform_delta.y = (int)(0);
				delta = &_internal_.transform_delta;
			}
			else
				_internal_.transform_delta = (FT_Vector_)(*delta);
			if ((delta->x | delta->y) != 0)
				_internal_.transform_flags |= (int)(2);
		}
		...
		public static void ft_glyphslot_grid_fit_metrics(FT_GlyphSlotRec_ slot, byte vertical)
		{
			...
			if ((vertical) != 0)
			{
				...
				metrics->horiBearingY = (int)(((int)((uint)(metrics->horiBearingY) + (uint)(63))) & ~63);
				right = (int)(((int)((uint)((int)((uint)(metrics->vertBearingX) + (uint)(metrics->width))) + (uint)(63))) & ~63);
				bottom = (int)(((int)((uint)((int)((uint)(metrics->vertBearingY) + (uint)(metrics->height))) + (uint)(63))) & ~63);
				metrics->vertBearingX = (int)((metrics->vertBearingX) & ~63);
				metrics->vertBearingY = (int)((metrics->vertBearingY) & ~63);
				metrics->width = ((int)((uint)(right) - (uint)(metrics->vertBearingX)));
				metrics->height = ((int)((uint)(bottom) - (uint)(metrics->vertBearingY)));
			}
			else
			{
				metrics->vertBearingX = (int)((metrics->vertBearingX) & ~63);
				metrics->vertBearingY = (int)((metrics->vertBearingY) & ~63);
				right = (int)(((int)((uint)((int)((uint)(metrics->horiBearingX) + (uint)(metrics->width))) + (uint)(63))) & ~63);
				bottom = (int)(((int)((uint)(metrics->horiBearingY) - (uint)(metrics->height))) & ~63);
				metrics->horiBearingX = (int)((metrics->horiBearingX) & ~63);
				metrics->horiBearingY = (int)(((int)((uint)(metrics->horiBearingY) + (uint)(63))) & ~63);
				metrics->width = ((int)((uint)(right) - (uint)(metrics->horiBearingX)));
				metrics->height = ((int)((uint)(metrics->horiBearingY) - (uint)(bottom)));
			}

			metrics->horiAdvance = (int)(((int)((uint)(metrics->horiAdvance) + (uint)(32))) & ~63);
			metrics->vertAdvance = (int)(((int)((uint)(metrics->vertAdvance) + (uint)(32))) & ~63);
		}
		...
		public static int FT_Load_Glyph(FT_FaceRec_ face, uint glyph_index, int load_flags)
		{
			...
			if ((load_flags & (1 << 22)) != 0)
				load_flags &= (int)(~(1 << 2));
			if (((((((hinter) != null) && ((load_flags & (1 << 1)) == 0)) && ((load_flags & (1 << 15)) == 0)) && (!!((face).face_flags & (1 << 0)))) && (!(!!((face).face_flags & (1 << 13))))) && ((((load_flags & (1 << 11)) != 0) || (((face._internal_.transform_matrix.yx) == (0)) && (face._internal_.transform_matrix.xx != 0))) || (((face._internal_.transform_matrix.xx) == (0)) && (face._internal_.transform_matrix.yx != 0))))
			{
			...
			if ((autohint) != 0)
			{
				...
				{
					FT_Face_InternalRec_ _internal_ = face._internal_;
					int transform_flags = (int)(_internal_.transform_flags);
					_internal_.transform_flags = (int)(0);
					hinting = (FT_AutoHinter_InterfaceRec_*)(hinter.clazz.module_interface);
					error = (int)(hinting->load_glyph((void*)(hinter), slot, face.size, (uint)(glyph_index), (int)(load_flags)));
					_internal_.transform_flags = (int)(transform_flags);
				}
			}
			else
			{
		...
		Load_Ok:
			...
			{
				FT_Face_InternalRec_ _internal_ = face._internal_;
				if ((_internal_.transform_flags) != 0)
				{
					FT_RendererRec_ renderer = ft_lookup_glyph_renderer(slot);
					if ((renderer) != null)
						error = (int)(renderer.clazz.transform_glyph(renderer, slot, &_internal_.transform_matrix, &_internal_.transform_delta));
					else if ((slot.format) == (FT_GLYPH_FORMAT_OUTLINE))
					{
						if ((_internal_.transform_flags & 1) != 0)
							FT_Outline_Transform(&slot.outline, &_internal_.transform_matrix);
						if ((_internal_.transform_flags & 2) != 0)
							FT_Outline_Translate(&slot.outline, (int)(_internal_.transform_delta.x), (int)(_internal_.transform_delta.y));
					}
					FT_Vector_Transform(&slot.advance, &_internal_.transform_matrix);
				}
			}

			slot.glyph_index = (uint)(glyph_index);
			slot._internal_.load_flags = (int)(load_flags);
		...
		public static int FT_Load_Char(FT_FaceRec_ face, uint char_code, int load_flags)
		{
			uint glyph_index = 0;
			if (face == null)
				return (int)(FT_Err_Invalid_Face_Handle);
			...
			if ((face.charmap) != null)
				glyph_index = (uint)(FT_Get_Char_Index(face, (uint)(char_code)));
		...
		public static void destroy_size(FT_MemoryRec_ memory, FT_SizeRec_ size, FT_DriverRec_ driver)
		{
			...
			do
			{
				(ft_mem_free(memory, (size._internal_)));
				(size._internal_) = null;
			}
			while ((0) != 0);
			do
			{
		...
		public static void destroy_face(FT_MemoryRec_ memory, FT_FaceRec_ face, FT_DriverRec_ driver)
		{
			...
			face.stream = null;
			if ((face._internal_) != null)
			{
				do
				{
					(ft_mem_free(memory, (face._internal_)));
					(face._internal_) = null;
				}
				while ((0) != 0);
			}
...
;) { }
		...
		public static int open_face(FT_DriverRec_ driver, FT_StreamRec_ astream, byte external_stream, int face_index, int num_params, FT_Parameter_* _params_, FT_FaceRec_ aface)
		{
			FT_MemoryRec_ memory;
			FT_Driver_ClassRec_ clazz;
			FT_FaceRec_ face = null;
			FT_Face_InternalRec_ _internal_ = null;
			int error = 0;
			int error2 = 0;
			clazz = driver.clazz;
			memory = driver.root.memory;
			if ((((face) = (ft_mem_alloc(memory, (int)(clazz.face_object_size), &error))), error != 0))
				goto Fail;
			face.driver = driver;
			face.memory = memory;
			face.stream = astream;
			if ((external_stream) != 0)
				face.face_flags |= (int)(1 << 10);
			if ((((_internal_) = (ft_mem_alloc(memory, (int)(sizeof((_internal_))), &error))), error != 0))
				goto Fail;
			face._internal_ = _internal_;
			{
				int i = 0;
				face._internal_.incremental_interface = null;
				for (i = (int)(0); ((i) < (num_params)) && (face._internal_.incremental_interface == null); i++)
				{ if ((_params_[i].tag) == (((uint)('i') << 24) | ((uint)('n') << 16) | ((uint)('c') << 8) | (uint)('r'))) face._internal_.incremental_interface = (FT_Incremental_InterfaceRec_)(_params_[i].data); }
			}

			face._internal_.random_seed = (int)(-1);
			if ((clazz.init_face) != null)
				error = (int)(clazz.init_face(astream, face, (int)(face_index), (int)(num_params), _params_));
			astream = face.stream;
			if ((error) != 0)
				goto Fail;
		...
		public static int new_memory_stream(FT_LibraryRec_ library, byte* _base_, uint size, void (FT_StreamRec_*) * close, FT_StreamRec_ astream)
		{
			int error = 0;
			FT_MemoryRec_ memory;
			FT_StreamRec_ stream = null;
			...
			if ((((stream) = (ft_mem_alloc(memory, (int)(sizeof((stream))), &error))), error != 0))
				goto Exit;
			FT_Stream_OpenMemory(stream, _base_, (uint)(size));
			stream.close = close;
			astream = stream;
		Exit:
			;
		...
		public static int open_face_from_buffer(FT_LibraryRec_ library, byte* _base_, uint size, int face_index, sbyte* driver_name, FT_FaceRec_ aface)
		{
			FT_Open_Args_ args = new FT_Open_Args_();
			int error = 0;
			FT_StreamRec_ stream = null;
			FT_MemoryRec_ memory = library.memory;
			error = (int)(new_memory_stream(library, _base_, (uint)(size), memory_stream_close, stream));
			if ((error) != 0)
			{
				do
				{
		...
		public static int ft_lookup_PS_in_sfnt_stream(FT_StreamRec_ stream, int face_index, uint* offset, uint* length, byte* is_sfnt_cid)
		{
			int error = 0;
			ushort numTables = 0;
			int pstable_index = 0;
			...
			*length = (uint)(0);
			*is_sfnt_cid = (byte)(0);
			if ((tag = (uint)(FT_Stream_ReadULong(stream, &error)), error != FT_Err_Ok))
				return (int)(error);
			if (tag != (((uint)('t') << 24) | ((uint)('y') << 16) | ((uint)('p') << 8) | (uint)('1')))
			...
			*is_sfnt_cid = (byte)(0);
			...
			{
				if ((((tag = (uint)(FT_Stream_ReadULong(stream, &error)), error != FT_Err_Ok) || ((error = (int)(FT_Stream_Skip(stream, (int)(4)))) != 0)) || (*offset = (uint)(FT_Stream_ReadULong(stream, &error)), error != FT_Err_Ok)) || (*length = (uint)(FT_Stream_ReadULong(stream, &error)), error != FT_Err_Ok))
					return (int)(error);
				if ((tag) == (((uint)('C') << 24) | ((uint)('I') << 16) | ((uint)('D') << 8) | (uint)(' ')))
				{
					pstable_index++;
					*offset += (uint)(22);
					*length -= (uint)(22);
				...
				else if ((tag) == (((uint)('T') << 24) | ((uint)('Y') << 16) | ((uint)('P') << 8) | (uint)('1')))
				{
					pstable_index++;
					*offset += (uint)(24);
					*length -= (uint)(24);
		...
		public static int open_face_PS_from_sfnt_stream(FT_LibraryRec_ library, FT_StreamRec_ stream, int face_index, int num_params, FT_Parameter_* _params_, FT_FaceRec_ aface)
		{
			int error = 0;
			FT_MemoryRec_ memory = library.memory;
			uint offset = 0;
			...
			error = (int)(FT_Stream_Seek(stream, (uint)(pos + offset)));
			if ((error) != 0)
				goto Exit;
			if ((((sfnt_ps) = (ft_mem_alloc(memory, ((int)(length)), &error))), error != 0))
				goto Exit;
			error = (int)(FT_Stream_Read(stream, sfnt_ps, (uint)(length)));
			if ((error) != 0)
			{
				do
				{
			...
			error = (int)(open_face_from_buffer(library, sfnt_ps, (uint)(length), (int)((face_index) < (0) ? (face_index) : (0)), (is_sfnt_cid) != 0 ? "cid" : "type1", aface));
		Exit:
			;
			{
				int error1 = 0;
				...
				{
					error1 = (int)(FT_Stream_Seek(stream, (uint)(pos)));
					if ((error1) != 0)
						return (int)(error1);
				}
				return (int)(error);
		...
		public static int Mac_Read_POST_Resource(FT_LibraryRec_ library, FT_StreamRec_ stream, int* offsets, int resource_cnt, int face_index, FT_FaceRec_ aface)
		{
			...
			{
				error = (int)(FT_Stream_Seek(stream, (uint)(offsets[i])));
				if ((error) != 0)
					goto Exit;
				if ((temp = (uint)(FT_Stream_ReadULong(stream, &error)), error != FT_Err_Ok))
					goto Exit;
			...
			if ((((pfb_data) = (ft_mem_alloc(memory, (int)((int)(pfb_len) + 2), &error))), error != 0))
				goto Exit;
			...
			for (i = (int)(0); (i) < (resource_cnt); i++)
			{
				...
				if ((error) != 0)
					goto Exit2;
				if ((rlen = (uint)(FT_Stream_ReadULong(stream, &error)), error != FT_Err_Ok))
					goto Exit2;
				if ((0x7FFFFFFFU) < (rlen))
				{
					error = (int)(FT_Err_Invalid_Offset);
				...
				if (((pfb_pos) > (pfb_len)) || ((pfb_pos + rlen) > (pfb_len)))
					goto Exit2;
				error = (int)(FT_Stream_Read(stream, pfb_data + pfb_pos, (uint)(rlen)));
				if ((error) != 0)
					goto Exit2;
				pfb_pos += (uint)(rlen);
			}
			...
			pfb_data[pfb_lenpos + 2] = ((byte)(len >> 16));
			pfb_data[pfb_lenpos + 3] = ((byte)(len >> 24));
			return (int)(open_face_from_buffer(library, pfb_data, (uint)(pfb_pos), (int)(face_index), "type1", aface));
		Exit2:
			;
			if ((((error) & 255) == ((FT_Err_Array_Too_Large) & 255)))  else if ((((error) & 255) == ((FT_Err_Invalid_Offset) & 255)))
					;
			if ((error) != 0)
		...
		public static int Mac_Read_sfnt_Resource(FT_LibraryRec_ library, FT_StreamRec_ stream, int* offsets, int resource_cnt, int face_index, FT_FaceRec_ aface)
		{
			...
			flag_offset = ((uint)(offsets[face_index]));
			error = (int)(FT_Stream_Seek(stream, (uint)(flag_offset)));
			if ((error) != 0)
				goto Exit;
			...
			error = (int)(open_face_from_buffer(library, sfnt_data, (uint)(rlen), (int)(face_index_in_resource), (is_cff) != 0 ? "cff" : "truetype", aface));
		Exit:
			;
			return (int)(error);
		}
		...
		public static int IsMacResource(FT_LibraryRec_ library, FT_StreamRec_ stream, int resource_offset, int face_index, FT_FaceRec_ aface)
		{
			...
			if ((error) != 0)
				return (int)(error);
			error = (int)(FT_Raccess_Get_DataOffsets(library, stream, (int)(map_offset), (int)(rdata_pos), (int)(((uint)('P') << 24) | ((uint)('O') << 16) | ((uint)('S') << 8) | (uint)('T')), (byte)(1), &data_offsets, &count));
			if (error == 0)
			{
			...
			error = (int)(FT_Raccess_Get_DataOffsets(library, stream, (int)(map_offset), (int)(rdata_pos), (int)(((uint)('s') << 24) | ((uint)('f') << 16) | ((uint)('n') << 8) | (uint)('t')), (byte)(0), &data_offsets, &count));
			if (error == 0)
			{
		...
		public static int IsMacBinary(FT_LibraryRec_ library, FT_StreamRec_ stream, int face_index, FT_FaceRec_ aface)
		{
			...
			error = (int)(FT_Stream_Seek(stream, (uint)(0)));
			if ((error) != 0)
				goto Exit;
			error = (int)(FT_Stream_Read(stream, header, (uint)(128)));
			if ((error) != 0)
				goto Exit;
		...
		public static int ft_open_face_internal(FT_LibraryRec_ library, FT_Open_Args_* args, int face_index, FT_FaceRec_ aface, byte test_mac_fonts)
		{
			...
			if (((args->flags & 8) != 0) && ((args->driver) != null))
			{
				...
				if ((((FT_ModuleRec_)(driver)).clazz.module_flags & 1) != 0)
				{
					...
					FT_Parameter_* _params_ = null;
					if ((args->flags & 16) != 0)
					{
						num_params = (int)(args->num_params);
						_params_ = args->_params_;
					}
					error = (int)(open_face(driver, stream, (byte)(external_stream), (int)(face_index), (int)(num_params), _params_, face));
					if (error == 0)
						goto Success;
				}
				else
				...
				for (; (cur) < (limit); cur++)
				{
					if (((cur[0]).clazz.module_flags & 1) != 0)
					{
						...
						if ((((test_mac_fonts) != 0) && ((strcmp(cur[0].clazz.module_name, "truetype")) == (0))) && (((error) & 255) == ((FT_Err_Table_Missing) & 255)))
						{
							...
							if ((error) != 0)
								break;
							error = (int)(open_face_PS_from_sfnt_stream(library, stream, (int)(face_index), (int)(num_params), _params_, aface));
							if (error == 0)
							{
								FT_Stream_Free(stream, (int)(external_stream));
								return (int)(error);
		...
		Success:
...

			{
				...
				_internal_.transform_delta.x = (int)(0);
				_internal_.transform_delta.y = (int)(0);
				_internal_.refcount = (int)(1);
				_internal_.no_stem_darkening = (sbyte)(-1);
			}
		...
		public static int FT_New_Size(FT_FaceRec_ face, FT_SizeRec_ asize)
		{
			...
			FT_ListNodeRec_* node = null;
			FT_Size_InternalRec_* _internal_ = null;
			if (face == null)
				return (int)(FT_Err_Invalid_Face_Handle);
			if (asize == null)
				return (int)(FT_Err_Invalid_Argument);
			...
			size.face = face;
			if ((((_internal_) = (ft_mem_alloc(memory, (int)(sizeof((*(_internal_)))), &error))) , error != 0)) goto Exit;
			size._internal_ = _internal_;
			if ((clazz.init_size) != null)
				error = (int)(clazz.init_size(size));
			if (error == 0)
			{
				asize = size;
				node->data = size;
		...
		public static int FT_Match_Size(FT_FaceRec_ face, FT_Size_RequestRec_* req, byte ignore_width, uint* size_index)
		{
			int i = 0;
			int w = 0;
			int h = 0;
		...
		public static void FT_Select_Metrics(FT_FaceRec_ face, uint strike_index)
		{
		...
		public static int FT_Select_Size(FT_FaceRec_ face, int strike_index)
		{
			...
			{
				error = (int)(clazz.select_size(face.size, (uint)(strike_index)));
			}
			else
			{
				FT_Select_Metrics(face, (uint)(strike_index));
			}
		...
		public static int FT_Request_Size(FT_FaceRec_ face, FT_Size_RequestRec_* req)
		{
			...
			if ((((req == null) || ((req->width) < (0))) || ((req->height) < (0))) || ((req->type) >= (FT_SIZE_REQUEST_TYPE_MAX)))
				return (int)(FT_Err_Invalid_Argument);
			face.size._internal_->autohint_metrics.x_scale = (int)(0);
			clazz = face.driver.clazz;
		...
		public static uint FT_Get_Char_Index(FT_FaceRec_ face, uint charcode)
		{
			uint result = (uint)(0);
		...
		public static uint FT_Get_First_Char(FT_FaceRec_ face, uint* agindex)
		{
			uint result = (uint)(0);
			uint gindex = (uint)(0);
			if ((((face) != null) && ((face.charmap) != null)) && ((face.num_glyphs) != 0))
			{
				gindex = (uint)(FT_Get_Char_Index(face, (uint)(0)));
				if ((gindex) == (0))
					result = (uint)(FT_Get_Next_Char(face, (uint)(0), &gindex));
			}
		...
		public static uint FT_Get_Next_Char(FT_FaceRec_ face, uint charcode, uint* agindex)
		{
			uint result = (uint)(0);
			uint gindex = (uint)(0);
			if ((((face) != null) && ((face.charmap) != null)) && ((face.num_glyphs) != 0))
		...
		public static int FT_Face_Properties(FT_FaceRec_ face, uint num_properties, FT_Parameter_* properties)
		{
			...
			{
				if ((properties->tag) == (((uint)('d') << 24) | ((uint)('a') << 16) | ((uint)('r') << 8) | (uint)('k')))
				{
					if ((properties->data) != null)
					{
						if ((*((byte*)(properties->data))) == (1))
							face._internal_.no_stem_darkening = (sbyte)(0);
						else
							face._internal_.no_stem_darkening = (sbyte)(1);
					}
					else
					{
						face._internal_.no_stem_darkening = (sbyte)(-1);
				...
				else if ((properties->tag) == (((uint)('l') << 24) | ((uint)('c') << 16) | ((uint)('d') << 8) | (uint)('f')))
				{
					error = (int)(FT_Err_Unimplemented_Feature);
					goto Exit;
				}
				else if ((properties->tag) == (((uint)('s') << 24) | ((uint)('e') << 16) | ((uint)('e') << 8) | (uint)('d')))
				{
					if ((properties->data) != null)
					{
						face._internal_.random_seed = (int)(*((int*)(properties->data)));
						if ((face._internal_.random_seed) < (0))
							face._internal_.random_seed = (int)(0);
					}
					else
					{
						face._internal_.random_seed = (int)(-1);
		...
		public static uint FT_Face_GetCharVariantIndex(FT_FaceRec_ face, uint charcode, uint variantSelector)
		{
			uint result = (uint)(0);
		...
		public static int FT_Face_GetCharVariantIsDefault(FT_FaceRec_ face, uint charcode, uint variantSelector)
		{
			int result = (int)(-1);
			if ((face) != null)
			{
		...
		public static uint* FT_Face_GetVariantsOfChar(FT_FaceRec_ face, uint charcode)
		{
			uint* result = null;
			if ((face) != null)
			{
		...
		public static uint* FT_Face_GetCharsOfVariant(FT_FaceRec_ face, uint variantSelector)
		{
			uint* result = null;
			if ((face) != null)
			{
		...
		public static uint FT_Get_Name_Index(FT_FaceRec_ face, sbyte* glyph_name)
		{
			...
			if ((((face) != null) && (!!((face).face_flags & (1 << 9)))) && ((glyph_name) != null))
			{
				...
				{
					void* svc;
					svc = (face)._internal_.services.service_GLYPH_DICT;
					if ((svc) == ((void*)(~(long)(1))))
						svc = null;
					else if ((svc) == null)
					{
						...
						while ((0) != 0);
						(face)._internal_.services.service_GLYPH_DICT = (svc != null ? svc : ((void*)(~(long)(1))));
					}
					service = svc;
				}
				while ((0) != 0);
				if (((service) != null) && ((service.name_index) != null))
					result = (uint)(service.name_index(face, glyph_name));
			}
		...
		public static int FT_Get_Glyph_Name(FT_FaceRec_ face, uint glyph_index, void* buffer, uint buffer_max)
		{
			...
			while ((0) != 0);
			if (((service) != null) && ((service.get_name) != null))
				error = (int)(service.get_name(face, (uint)(glyph_index), buffer, (uint)(buffer_max)));
			else
				error = (int)(FT_Err_Invalid_Argument);
			return (int)(error);
		}
		...
		public static sbyte* FT_Get_Postscript_Name(FT_FaceRec_ face)
		{
			...
			if (result == null)
			{
				...
				{
					void* svc;
					svc = (face)._internal_.services.service_POSTSCRIPT_FONT_NAME;
					if ((svc) == ((void*)(~(long)(1))))
						svc = null;
					else if ((svc) == null)
					{
						...
						while ((0) != 0);
						(face)._internal_.services.service_POSTSCRIPT_FONT_NAME = (svc != null ? svc : ((void*)(~(long)(1))));
					}
					service = svc;
				}
				while ((0) != 0);
				if (((service) != null) && ((service.get_ps_font_name) != null))
		...
		public static int FT_Load_Sfnt_Table(FT_FaceRec_ face, uint tag, int offset, byte* buffer, uint* length)
		{
			FT_Service_SFNT_TableRec_ service;
			if ((face == null) || (!(!!((face).face_flags & (1 << 3)))))
				return (int)(FT_Err_Invalid_Face_Handle);
			...
			if (service == null)
				return (int)(FT_Err_Unimplemented_Feature);
			return (int)(service.load_table(face, (uint)(tag), (int)(offset), buffer, length));
		}

		public static int FT_Sfnt_Table_Info(FT_FaceRec_ face, uint table_index, uint* tag, uint* length)
		{
			FT_Service_SFNT_TableRec_ service;
			uint offset = 0;
			if ((face == null) || (!(!!((face).face_flags & (1 << 3)))))
		...
		public static uint FT_Get_CMap_Language_ID(FT_CharMapRec_ charmap)
		{
			...
			if ((service->get_cmap_info(charmap, &cmap_info)) != 0)
				return (uint)(0);
			return (uint)(cmap_info.language);
		}
		...
		public static int FT_Set_Renderer(FT_LibraryRec_ library, FT_RendererRec_ renderer, uint num_params, FT_Parameter_* parameters)
		{
			...
			{
				error = (int)(set_mode(renderer, (uint)(parameters->tag), parameters->data));
				if ((error) != 0)
					break;
				parameters++;
			}
		...
		public static int FT_Render_Glyph_Internal(FT_LibraryRec_ library, FT_GlyphSlotRec_ slot, int render_mode)
		{
			...
			switch (slot.format)
			{
				case FT_GLYPH_FORMAT_BITMAP:
					break;
				default:
					if ((slot._internal_.load_flags & (1 << 20)) != 0)
					{
						...
						if ((have_layers) != 0)
						{
							...
							if (error == 0)
							{
								...
								do
								{
									int load_flags = (int)(slot._internal_.load_flags);
									load_flags &= (int)(~(1 << 20));
									load_flags |= (int)(1 << 2);
								...
								if (error == 0)
									slot.format = (int)(FT_GLYPH_FORMAT_BITMAP);
								FT_Done_GlyphSlot(face.glyph);
							}
							if (error == 0)
								return (int)(error);
		...
		public static int ft_property_do(FT_LibraryRec_ library, sbyte* module_name, sbyte* property_name, void* value, byte set, byte value_is_string)
		{
			...
			limit = cur[library.num_modules];
			for (; (cur) < (limit); cur++)
			{ if (strcmp(cur[0].clazz.module_name, module_name) == 0) break; }
			if ((cur) == (limit))
			{
				do
				{
			...
			_interface_ = cur[0].clazz.get_interface(cur[0], "properties");
			if (_interface_ == null)
			{
				do
				{
			...
			service = (FT_Service_PropertiesRec_)(_interface_);
			if ((set) != 0)
				missing_func = ((byte)((!service.set_property) != 0));
			else
				missing_func = ((byte)((!service.get_property) != 0));
			if ((missing_func) != 0)
			{
				do
				{
		...
		public static int FT_Outline_Copy(FT_Outline_* source, FT_Outline_* target)
		{
			...
			if ((source->n_contours) != 0)
				CRuntime.memcpy(target->contours, source->contours, (ulong)((ulong)(source->n_contours) * sizeof((*(target->contours)))));
		...
		public static void FT_Outline_Translate(FT_Outline_* outline, int xOffset, int yOffset)
		{
			...
			{
				vec->x = ((int)((uint)(vec->x) + (uint)(xOffset)));
				vec->y = ((int)((uint)(vec->y) + (uint)(yOffset)));
				vec++;
			}
		}
		...
		public static int FT_Outline_Render(FT_LibraryRec_ library, FT_Outline_* outline, FT_Raster_Params_ _params_)
		{
			int error = 0;
			FT_RendererRec_ renderer;
			FT_ListNodeRec_* node;
			...
			renderer = library.cur_renderer;
			node = library.renderers.head;
			_params_.source = (void*)(outline);
			if (((_params_.flags & 2) != 0) && ((_params_.flags & 4) == 0))
			{
				_params_.clip_box.xMin = (int)(cbox.xMin >> 6);
				_params_.clip_box.yMin = (int)(cbox.yMin >> 6);
				_params_.clip_box.xMax = (int)((cbox.xMax + 63) >> 6);
				_params_.clip_box.yMax = (int)((cbox.yMax + 63) >> 6);
			}

			error = (int)(FT_Err_Cannot_Render_Glyph);
			while ((renderer) != null)
			{
				error = (int)(renderer.raster_render(renderer.raster, _params_));
				if ((error == 0) || (((error) & 255) != ((FT_Err_Cannot_Render_Glyph) & 255)))
					break;
		...
		{
			FT_Raster_Params_ _params_ = new FT_Raster_Params_();
			if (abitmap == null)
				return (int)(FT_Err_Invalid_Argument);
			_params_.target = abitmap;
			_params_.flags = (int)(0);
			if ((((abitmap->pixel_mode) == (FT_PIXEL_MODE_GRAY)) || ((abitmap->pixel_mode) == (FT_PIXEL_MODE_LCD))) || ((abitmap->pixel_mode) == (FT_PIXEL_MODE_LCD_V)))
				_params_.flags |= (int)(1);
			return (int)(FT_Outline_Render(library, outline, _params_));
		}
		...
		public static int FT_Outline_Get_Orientation(FT_Outline_* outline)
		{
			...
			for (c = (int)(0); (c) < (outline->n_contours); c++)
			{
				...
				for (n = (int)(first); n <= last; n++)
				{
					...
					area = ((int)((uint)(area) + (uint)((int)((uint)(v_cur.y - v_prev.y) * (uint)(v_cur.x + v_prev.x)))));
		...
		public static int FT_Raccess_Get_HeaderInfo(FT_LibraryRec_ library, FT_StreamRec_ stream, int rfork_offset, int* map_offset, int* rdata_pos)
		{
			...
			int type_list = 0;
			((library) = (library));
			error = (int)(FT_Stream_Seek(stream, (uint)(rfork_offset)));
			if ((error) != 0)
				return (int)(error);
			error = (int)(FT_Stream_Read(stream, head, (uint)(16)));
			if ((error) != 0)
				return (int)(error);
			...
			*rdata_pos = (int)((head[0] << 24) | (head[1] << 16) | (head[2] << 8) | head[3]);
			...
			if (((((((2147483647 - rdata_len) < (*rdata_pos)) || ((2147483647 - map_len) < (map_pos))) || ((2147483647 - (*rdata_pos + rdata_len)) < (rfork_offset))) || ((2147483647 - (map_pos + map_len)) < (rfork_offset))) || (((uint)(rfork_offset + *rdata_pos + rdata_len)) > (stream.size))) || (((uint)(rfork_offset + map_pos + map_len)) > (stream.size)))
				return (int)(FT_Err_Unknown_File_Format);
			*rdata_pos += (int)(rfork_offset);
			map_pos += (int)(rfork_offset);
			error = (int)(FT_Stream_Seek(stream, (uint)(map_pos)));
			if ((error) != 0)
				return (int)(error);
			head2[15] = ((byte)(head[15] + 1));
			error = (int)(FT_Stream_Read(stream, head2, (uint)(16)));
			if ((error) != 0)
				return (int)(error);
			allzeros = (int)(1);
			allmatch = (int)(1);
			...
			if ((type_list) < (0))
				return (int)(FT_Err_Unknown_File_Format);
			error = (int)(FT_Stream_Seek(stream, (uint)(map_pos + type_list)));
			if ((error) != 0)
				return (int)(error);
		...
		public static void FT_Raccess_Guess(FT_LibraryRec_ library, FT_StreamRec_ stream, sbyte* base_name, sbyte** new_names, int* offsets, int* errors)
		{
			...
			for (i = (int)(0); (i) < (9); i++)
			{
				new_names[i] = null;
				if (null != stream)
					errors[i] = (int)(FT_Stream_Seek(stream, (uint)(0)));
				else
			...
			if ((((aname) != null) && ((face) != null)) && (!!((face).face_flags & (1 << 3))))
			{
				...
				if ((idx) < ((uint)(ttface.num_names)))
				{
					...
					if (((entry->stringLength) > (0)) && (entry->_string_ == null))
					{
						...
						if (((((entry->_string_) = (ft_mem_realloc(memory, (int)(sizeof((*(entry->_string_)))), (int)(0), (int)(entry->stringLength), null, &error))) , error != 0) || ((error = (int)(FT_Stream_Seek(stream, (uint)(entry->stringOffset)))) != 0)) || ((error = (int)(FT_Stream_Read(stream, (entry->_string_), (uint)(entry->stringLength)))) != 0)) {
							do
							{
		...
		public static void FT_Stream_OpenMemory(FT_StreamRec_ stream, byte* _base_, uint size)
		{
			stream._base_ = _base_;
			stream.size = (uint)(size);
			stream.pos = (uint)(0);
			stream.cursor = null;
			stream.read = null;
			stream.close = null;
		...
		public static int FT_Stream_Seek(FT_StreamRec_ stream, uint pos)
		{
			int error = (int)(FT_Err_Ok);
			if ((stream.read) != null)
			{
				if ((stream.read(stream, (uint)(pos), null, (uint)(0))) != 0)
				{
					do
					{
					}
		...
		public static int FT_Stream_Skip(FT_StreamRec_ stream, int distance)
		{
			if ((distance) < (0))
				return (int)(FT_Err_Invalid_Stream_Operation);
			return (int)(FT_Stream_Seek(stream, (uint)(stream.pos + (uint)(distance))));
		}

		public static uint FT_Stream_Pos(FT_StreamRec_ stream)
		{
			return (uint)(stream.pos);
		}

		public static int FT_Stream_Read(FT_StreamRec_ stream, byte* buffer, uint count)
		{
			return (int)(FT_Stream_ReadAt(stream, (uint)(stream.pos), buffer, (uint)(count)));
		}

		public static int FT_Stream_ReadAt(FT_StreamRec_ stream, uint pos, byte* buffer, uint count)
		{
			int error = (int)(FT_Err_Ok);
			uint read_bytes = 0;
			if ((pos) >= (stream.size))
			...
			if ((stream.read) != null)
				read_bytes = (uint)(stream.read(stream, (uint)(pos), buffer, (uint)(count)));
			else
			{
				read_bytes = (uint)(stream.size - pos);
				if ((read_bytes) > (count))
					read_bytes = (uint)(count);
				CRuntime.memcpy(buffer, stream._base_ + pos, (ulong)(read_bytes));
			}

			stream.pos = (uint)(pos + read_bytes);
			if ((read_bytes) < (count))
			{
				do
				{
		...
		public static uint FT_Stream_TryRead(FT_StreamRec_ stream, byte* buffer, uint count)
		{
			uint read_bytes = (uint)(0);
			if ((stream.pos) >= (stream.size))
				goto Exit;
			if ((stream.read) != null)
				read_bytes = (uint)(stream.read(stream, (uint)(stream.pos), buffer, (uint)(count)));
			else
			{
				read_bytes = (uint)(stream.size - stream.pos);
				if ((read_bytes) > (count))
					read_bytes = (uint)(count);
				CRuntime.memcpy(buffer, stream._base_ + stream.pos, (ulong)(read_bytes));
			}

			stream.pos += (uint)(read_bytes);
		Exit:
			;
			return (uint)(read_bytes);
		}

		public static int FT_Stream_ExtractFrame(FT_StreamRec_ stream, uint count, byte** pbytes)
		{
			int error = 0;
			error = (int)(FT_Stream_EnterFrame(stream, (uint)(count)));
			if (error == 0)
			{
		...
		public static int FT_Stream_EnterFrame(FT_StreamRec_ stream, uint count)
		{
			int error = (int)(FT_Err_Ok);
			uint read_bytes = 0;
			do
			...
			if ((stream.read) != null)
			{
				...
				if ((((stream._base_) = (ft_mem_qalloc(memory, (int)(count), &error))), error != 0))
					goto Exit;
				read_bytes = (uint)(stream.read(stream, (uint)(stream.pos), stream._base_, (uint)(count)));
				if ((read_bytes) < (count))
				{
					do
					{
		...
		public static uint FT_Stream_GetUOffset(FT_StreamRec_ stream)
		{
			byte* p;
			uint result = 0;
			do
			...
			p = stream.cursor;
			if ((p + 2) < (stream.limit))
				result = (uint)(p += 3, ((((uint)((p - 3)[(0)])) << (16)) | (((uint)((p - 3)[(1)])) << (8)) | (((uint)((p - 3)[(2)])) << (0))));
			stream.cursor = p;
			return (uint)(result);
		}

		public static uint FT_Stream_GetULong(FT_StreamRec_ stream)
		{
			byte* p;
			uint result = 0;
			do
			...
			p = stream.cursor;
			if ((p + 3) < (stream.limit))
				result = (uint)(p += 4, ((((uint)((p - 4)[(0)])) << (24)) | (((uint)((p - 4)[(1)])) << (16)) | (((uint)((p - 4)[(2)])) << (8)) | (((uint)((p - 4)[(3)])) << (0))));
			stream.cursor = p;
			return (uint)(result);
		}

		public static uint FT_Stream_GetULongLE(FT_StreamRec_ stream)
		{
			byte* p;
			uint result = 0;
			do
			...
			p = stream.cursor;
			if ((p + 3) < (stream.limit))
				result = (uint)(p += 4, ((((uint)((p - 4)[(3)])) << (24)) | (((uint)((p - 4)[(2)])) << (16)) | (((uint)((p - 4)[(1)])) << (8)) | (((uint)((p - 4)[(0)])) << (0))));
			stream.cursor = p;
			return (uint)(result);
		}
		...
		public static sbyte FT_Stream_ReadChar(FT_StreamRec_ stream, int* error)
		{
			...
			*error = (int)(FT_Err_Ok);
			if ((stream.read) != null)
			{
				if (stream.read(stream, (uint)(stream.pos), &result, (uint)(1)) != 1)
					goto Fail;
			}
			else
			{
		...
		public static ushort FT_Stream_ReadUShort(FT_StreamRec_ stream, int* error)
		{
			...
			*error = (int)(FT_Err_Ok);
			if ((stream.pos + 1) < (stream.size))
			{
				if ((stream.read) != null)
				{
					if (stream.read(stream, (uint)(stream.pos), reads, (uint)(2)) != 2)
						goto Fail;
					p = reads;
				}
				else
		...
		public static uint FT_Stream_ReadUOffset(FT_StreamRec_ stream, int* error)
		{
			...
			*error = (int)(FT_Err_Ok);
			if ((stream.pos + 2) < (stream.size))
			{
				if ((stream.read) != null)
				{
					if (stream.read(stream, (uint)(stream.pos), reads, (uint)(3)) != 3)
						goto Fail;
					p = reads;
				}
				else
		...
		public static uint FT_Stream_ReadULong(FT_StreamRec_ stream, int* error)
		{
			...
			*error = (int)(FT_Err_Ok);
			if ((stream.pos + 3) < (stream.size))
			{
				if ((stream.read) != null)
				{
					if (stream.read(stream, (uint)(stream.pos), reads, (uint)(4)) != 4)
						goto Fail;
					p = reads;
				}
				else
		...
		public static uint FT_Stream_ReadULongLE(FT_StreamRec_ stream, int* error)
		{
			byte* reads = stackalloc byte[4];
			byte* p = null;
			uint result = (uint)(0);
		...
		public static int FT_Stream_ReadFields(FT_StreamRec_ stream, FT_Frame_Field_* fields, void* structure)
		{
			...
			do
			{
				...
				{
					case ft_frame_start:
						error = (int)(FT_Stream_EnterFrame(stream, (uint)(fields->offset)));
						if ((error) != 0)
							goto Exit;
					...
					case ft_frame_ushort_be:
						value = (uint)(cursor += 2, ((ushort)((((ushort)((cursor - 2)[(0)])) << (8)) | (((ushort)((cursor - 2)[(1)])) << (0)))));
						sign_shift = (int)(16);
						break;
					case ft_frame_short_le:
					case ft_frame_ushort_le:
						value = (uint)(cursor += 2, ((ushort)((((ushort)((cursor - 2)[(1)])) << (8)) | (((ushort)((cursor - 2)[(0)])) << (0)))));
						sign_shift = (int)(16);
						break;
					case ft_frame_long_be:
					case ft_frame_ulong_be:
						value = (uint)(cursor += 4, ((((uint)((cursor - 4)[(0)])) << (24)) | (((uint)((cursor - 4)[(1)])) << (16)) | (((uint)((cursor - 4)[(2)])) << (8)) | (((uint)((cursor - 4)[(3)])) << (0))));
						sign_shift = (int)(0);
						break;
					case ft_frame_long_le:
					case ft_frame_ulong_le:
						value = (uint)(cursor += 4, ((((uint)((cursor - 4)[(3)])) << (24)) | (((uint)((cursor - 4)[(2)])) << (16)) | (((uint)((cursor - 4)[(1)])) << (8)) | (((uint)((cursor - 4)[(0)])) << (0))));
						sign_shift = (int)(0);
						break;
					case ft_frame_off3_be:
					case ft_frame_uoff3_be:
						value = (uint)(cursor += 3, ((((uint)((cursor - 3)[(0)])) << (16)) | (((uint)((cursor - 3)[(1)])) << (8)) | (((uint)((cursor - 3)[(2)])) << (0))));
						sign_shift = (int)(8);
						break;
					case ft_frame_off3_le:
					case ft_frame_uoff3_le:
						value = (uint)(cursor += 3, ((((uint)((cursor - 3)[(2)])) << (16)) | (((uint)((cursor - 3)[(1)])) << (8)) | (((uint)((cursor - 3)[(0)])) << (0))));
						sign_shift = (int)(8);
						break;
					default:
				...
				if ((fields->value & 1) != 0)
					value = ((uint)((int)(value << sign_shift) >> sign_shift));
				p = (byte*)(structure) + fields->offset;
				switch (fields->size)
				{
					case (8 / 8):
		...
		public static int ft_trig_prenorm(FT_Vector_* vec)
		{
			...
			{
				shift = (int)(29 - shift);
				vec->x = ((int)((uint)(x) << shift));
				vec->y = ((int)((uint)(y) << shift));
			}
			else
			{
				shift -= (int)(29);
		...
		public static void FT_Vector_Rotate(FT_Vector_* vec, int angle)
		{
			...
			{
				shift = (int)(-shift);
				vec->x = ((int)((uint)(v.x) << shift));
				vec->y = ((int)((uint)(v.y) << shift));
			}
		...
		public static void* ft_mem_dup(FT_MemoryRec_ memory, void* address, uint size, int* p_error)
		{
			int error = 0;
		...
		{
			uint len = (uint)(str ? (uint)(CRuntime.strlen(str)) + 1 : 0);
			return ft_mem_dup(memory, str, (uint)(len), p_error);
		}

		public static int ft_mem_strcpyn(sbyte* dst, sbyte* src, uint size)
		{
			while (((size) > (1)) && (*src != 0))
			{
				*dst++ = (sbyte)(*src++);
